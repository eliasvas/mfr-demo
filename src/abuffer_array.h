#ifndef ABUFFER_ARRAY_H
#define ABUFFER__ARRAY_H
...
{
    shader_load(&clear_abuffer_shader,"../assets/shaders/pass_through.vert","../assets/shaders/clear_abuf_array.frag");
    shader_load(&render_abuffer_shader,"../assets/shaders/render_abuf_array.vert","../assets/shaders/render_abuf_array.frag");
    shader_load(&render_abuffer_quad_shader,"../assets/shaders/render_abuf_quad_array.vert","../assets/shaders/render_abuf_array.frag");
    shader_load(&display_abuffer_shader,"../assets/shaders/pass_through.vert","../assets/shaders/disp_abuf_array.frag");
}
